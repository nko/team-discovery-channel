...
exports.executeTest = function( url ) {
    ...
    jsdom.jQueryify(document, "support/jsdom/example/jquery/jquery.js", function() {
      ...
      request('nko-team-discovery-channel.heroku.com', '/tests/index.html', function( content ) {
          if ( content ) {
              ...
              request('nko-team-discovery-channel.heroku.com', '/tests/unit/example.js', function( unit ) {
