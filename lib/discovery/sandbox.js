...
exports.executeTest = function( url ) {
    ...
    jsdom.jQueryify(document, "support/jsdom/example/jquery/jquery.js", function() {
      ...
      request('github.com', '/nko/team-discovery-channel/raw/master/tests/index.html', function( content ) {
          if ( content ) {
              ...
              request('github.com', '/nko/team-discovery-channel/raw/master/tests/unit/example.js', function( unit ) {
