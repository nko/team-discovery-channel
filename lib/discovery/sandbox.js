 ...
 * fails.
 */
exports.handleBuildTweets = function(gitPayload, buildPayload) {
    sys.puts(JSON.stringify(buildPayload));
    sys.puts(JSON.stringify(gitPayload));
    ...
    if (fail) {
        ...
        t.update('json', {status: "Hey " + gitPayload.pusher.name + " it looks like you broke the build!"}, function(result) {
